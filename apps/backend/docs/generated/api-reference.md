...
*Defined in `src/routes/api.ts:80`*
...
*Defined in `src/routes/versions.ts:96`*
...
*Defined in `src/middleware/auth.ts:87`*
...
*Defined in `src/routes/lifecycle.ts:52`*
...
*Defined in `src/routes/patches.ts:14`*
...
*Defined in `src/routes/merge.ts:79`*
