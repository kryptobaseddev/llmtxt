...
description: Real-time awareness of which agents are editing which sections, relayed via the 0x04 AwarenessRelay frame on the loro-sync-v1 WebSocket connection.
---
...
`loro-sync-v1` WebSocket connection (see [CRDT Section Collaboration](/docs/multi-agent/crdt-sections)
