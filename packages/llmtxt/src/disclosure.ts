...
//
// All logic is in crates/llmtxt-core::disclosure. The wasm.ts module
// re-exports these with TypeScript-friendly signatures. This file re-exports
// them under the original names to preserve backward compatibility.
